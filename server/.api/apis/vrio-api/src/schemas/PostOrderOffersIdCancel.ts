const PostOrderOffersIdCancel = {
  "body": {
    "type": "object",
    "properties": {
      "cancel_type_id": {
        "type": "integer",
        "description": "Send the cancel type id that can be found in the Cancel Reasons section of Vrio."
      },
      "order_offer_notes": {
        "type": "string",
...
export default PostOrderOffersIdCancel
