  ...
  useEffect(() => {
    ...
    const verify = async () => {
      try {
        ...
        await api.post("/patients/verify-email", { token });
        setStatus("success");
          ...
          <CardContent className="pt-4 space-y-4">
            {status === "loading" && (
              <div className="space-y-4">
                ...
                <p className="text-xs text-gray-500">Please wait while we confirm your credentials</p>
              </div>
            )}
            ...
            {status === "success" && (
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-600">
                  Your TeleClinic account is active. Redirecting you to login in a moment...
                </p>
                <Link to="/patient/login" className="inline-block pt-2">
            ...
            {status === "failed" && (
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-600">
                  This verification token is invalid or has expired.
                </p>
                <Link to="/patient/login" className="inline-block pt-2">
